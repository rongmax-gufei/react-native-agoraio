...
//获取当前屏幕的高度
#define ScreenHeight_AG ([[UIScreen mainScreen] bounds].size.height)

//获取当前屏幕的宽度
#define ScreenWidth_AG  ([[UIScreen mainScreen] bounds].size.width)
...
#define AGStickerDownloadBaseURL @"https://omhooyf5o.qnssl.com"
