...
#import "AGConst.h"
#import "Global.h"
#import "AGBeautyFilter.h"
#import "ColorFilterConst.h"
#import "AGGlobalFilter.h"

@interface AGRenderManager : NSObject

/**
 A video rendering classes
 */
@property(nonatomic, strong) AGRenderer *renderer;

/**
 贴纸滤镜
 */
@property (nonatomic, strong) AGStickerRenderer *stickerRender;


/**
 stickers collection
 */
@property(nonatomic, strong) NSMutableArray<AGSticker *> *stickers;

@property(nonatomic, strong) NSMutableArray<AGGlobalFilter *> *globalFilters;


/**
 present stickers collection
 */
@property(nonatomic, strong) NSMutableArray<AGSticker *> *presentStickers;


/** 
 distorting mirror filter collection
 */
@property(nonatomic, strong) NSArray<GPUImageOutput <GPUImageInput, AGRenderProtocol> *> *distortionFilters;

/**
 滤镜集合 
*/
//@property(nonatomic, strong) NSArray<GPUImageOutput <GPUImageInput, AGRenderProtocol> *> *colorFilters;
 ...
 */
@property(nonatomic, strong) GPUImageOutput <GPUImageInput, AGRenderProtocol> *currentDistortionFilter;
...
/**
 ...
 @param modelPath :the models file's path with a default path of AGResource.bundle/models(默认路径是 AGResource.bundle/models)
